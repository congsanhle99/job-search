    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.CharField(choices=[('Bachelors', 'Bachelors'), ('Engineer', 'Engineer'), ('Master', 'Master'), ('PhD', 'Phd')], default='Bachelors', max_length=10)),
                ...
                ('experience', models.CharField(choices=[('No Experience', 'No Experience'), ('6 Month', 'Six Month'), ('1 Years', 'One Year'), ('2 Years', 'Two Year'), ('3 Years+', 'Three Year Plus'), ('5 Years+', 'Five Year Plus')], default='No Experience', max_length=20)),
